...
public class TestRemider extends AppCompatActivity {
    String TAG = "RemindMe";
    LocalData localData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_remider);
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    NotificationScheduler.setReminder(TestRemider.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    NotificationScheduler.cancelReminder(TestRemider.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
